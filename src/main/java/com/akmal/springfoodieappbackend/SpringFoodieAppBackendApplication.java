...
import com.akmal.springfoodieappbackend.repository.*;
      ...
      if (restaurantRepository.count() == 0) {
        ...
        var address =
            new Address(
                ...
                "A",
                null,
                new Address.Location(40.3, 44.1));
        ...
        Restaurant restaurant =
            Restaurant.builder()
                ...
                .deliveryCost(BigDecimal.valueOf(20.4))
        ...
        var menu =
            Menu.builder()
                .name("Pizza")
                .category(italianCategory.get(1))
                .restaurant(restaurant)
                .build();
        ...
        var openingTimes =
            List.of(
                OpeningTime.builder()
                    .day(1)
                    .openFrom(LocalTime.parse("12:00:00"))
                    .restaurant(restaurant)
                    .openTill(LocalTime.parse("23:00:00"))
                    .build(),
                OpeningTime.builder()
                    .day(2)
                    .openFrom(LocalTime.parse("12:00:00"))
        ...
        MenuItem menuItem =
            MenuItem.builder()
                .menu(menu)
                .basePrice(BigDecimal.valueOf(1L))
                .name("Menu Items")
                .build();
        menuItem.addOptionSet(
            OptionSet.builder()
                .optionSetType(OptionSet.OptionSetType.TOPPING)
                .name("Extra cheese")
                .exclusive(false)
                .required(false)
                .maximumOptionsSelected(2)
                .orderPosition(1)
                .options(options)
                .build());
